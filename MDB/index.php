...
<body>
    ...
    <div class="view hm-black-strong" id="monIdMenu">
        <div class="full-bg-img flex-center">
            <ul>
                <li>
                    <h1 class="h1-responsive wow fadeInDown" data-wow-delay="0.2s">NewWorld</h1></li>
                <li>
                    <p class="wow fadeInDown">Les meilleurs produits de saison.
Du producteur a l'artisan et au consommateur.</br>
Ni usine, ni camion, ni grande surface.
La terre et l'homme a nouveau respectes
</p>
                </li>
                <li>
                    <a href="inscription.php" class="btn btn-primary btn-lg wow fadeInLeft" data-wow-delay="0.2s">Inscription</a>
                    <a href="connexion.php" class="btn btn-default btn-lg wow fadeInRight" data-wow-delay="0.2s">Connexion</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="divider-new">
            <h2 class="h2-responsive wow bounceIn">Info</h2>
        </div>
...
Vous souhaitez proposer au juste prix des produits de qualité, sains, frais et de saison.</p>
            ...
            <p><h5>Adulte éco-responsable</h5>

Vous êtes un père ou une mère de famille responsable qui sait non seulement que l'on doit manger sain mais aussi que pour maintenir un centre ville et des campagnes peuplés, il est nécessaire de donner leurs chances aux producteurs et artisants.Les emplois que vous maintenez aujourd'hui seront peut-être ceux de vos enfants. Il faut développer l'activité locale en réduisant les coûts de transport ainsi que les intermédiaires. Vous souhaitez proposer au juste prix des produits de qualité, sains, frais et de saison.</p>

	    <p><h5>Artisan de l'alimentaire</h5>
Vous transformez les produits frais locaux et souhaitez maintenir votre commerce de centre ville face à l'omniprésence des grandes surfaces. Vous voyez chaque jour autour de vous des magasins qui ferment. NewWorld peut vous permettre un complément d'activité. Tentez cela ne coûte rien.</p>

        </section>
        <!--Section: Info-->

        <div class="divider-new">
            <h2 class="h2-responsive wow fadeInDown">Principes</h2>
        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card wow fadeInUp">
                        ...
                        <div class="view overlay hm-white-slight">
                            <img src="img/img/boucher2" class="img-fluid" alt="">
                            <a>
                                <div class="mask"></div>
                            </a>
                        </div>
                        ...
                        <div class="card-block text-center">
                            <!--Title-->
                            <h4 class="card-title">Participer</h4>
                            <hr>
                            <!--Text-->
                            	<p class="card-text">Proposer des produits
Transformer</br>
Devenir client</br>
Distribue</br>
				</p>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <!--Card image-->
                        <div class="view overlay hm-white-slight">
                            <img src="img/img/jardinier2" class="img-fluid" alt="">
                            <a>
                                <div class="mask"></div>
                            </a>
                        </div>
    ...
    Qualité</br>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <!--Card image-->
                        <div class="view overlay hm-white-slight">
                            <img src="img/img/repas.jpg" class="img-fluid" alt="">
                            <a>
                                <div class="mask"></div>
                            </a>
                        </div>
                        ...
                        <div class="card-block text-center">
                            <!--Title-->
                            <h4 class="card-title">Commuiquer</h4>
                            <hr>
                            <!--Text-->
				<p class="card-text">
    Les secrets des producteurs</br>
    Le savoir faire des artisants</br>
    Les recettes de grand-mère</br>
    ...
    <script>
        function init_map() {
            ...
            var var_location = new google.maps.LatLng(44.561199, 6.075911);
